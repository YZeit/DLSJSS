...
public class CoevolutionStatistics extends Statistics implements SteadyStateStatisticsForm //, ec.eval.ProvidesBestSoFar
{
    ...
    public void finalStatistics(final EvolutionState state, final int result)
    {
        ...
        cellTestingIndexExecutionTime.setCellValue("best GP rule");
        for (int j=0; j<elapsedTimeValidation.length; j++){
            Cell cellTitleTrainingExecutionTime = titleRowTestingExecutionTime.createCell(j+1);
