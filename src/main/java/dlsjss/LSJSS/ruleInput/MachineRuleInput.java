...
public class MachineRuleInput {
    ...
    public Job execute(MachineRuleInput[] machines, String jss) {
        ...
        for (int i = 0; i<queueJob.size(); i++){
            ...
            double priority = ExpressionEvaluator.executeJSR(currentPT, currentRT, currentRPT, currentRNO, currentDD, currentRTO,
                    currentPTN, currentSL, currentWT, currentAPTQ, currentNJQ, currentWINQ, currentCT, jss);
